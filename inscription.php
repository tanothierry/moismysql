...
if(empty($errors)){
    // var_dump($_POST);
//   die();
    $req = $base->prepare("INSERT INTO `users`( `nom`, `prenom`, `ville`, `email`, `password`, `date_inscription`) VALUES (?,?,?,?,?,NOW())");
    $req->execute([$_POST['nom'], $_POST['firstname'], $_POST['ville'], $_POST['email'], $_POST['password']]);
        ...
        <?php endif; ?>
          <div class="row" >
            ...
            <h1>Inscription</h1>
                    ...
                    <input type="text" name="firstname" id="firstname" placeholder="Entrez votre prenoms">
                    <input type="text" name="nom" id="nom" placeholder="Entrez votre nom">
                    <input type="text" name="ville" id="ville" placeholder="Entrez votre ville">
                    <input type="email" name="email" id="email" placeholder="Entrez votre email">
                    <input type="password" name="password" id="password" placeholder="Mot de passe">
                    <input type="password" name="confirmpassword" id="password" placeholder="confirmer votre mot de password">
